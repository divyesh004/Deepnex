    ...
    <>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <a 
            href="/contact"
            className="inline-flex items-center justify-center bg-primary text-white px-8 py-3 sm:px-10 sm:py-4 rounded-lg font-medium hover:bg-accent transition-all duration-300 text-sm sm:text-base shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
          >
            Contact Us
          </a>
        </motion.div>
